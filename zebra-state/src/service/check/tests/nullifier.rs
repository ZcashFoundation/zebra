...
proptest! {
    ...
    fn reject_duplicate_orchard_nullifiers_in_transaction(
        authorized_action1 in TypeNameToDebug::<orchard::AuthorizedAction<tx_version::V5>>::arbitrary(),
        mut authorized_action2 in TypeNameToDebug::<orchard::AuthorizedAction<tx_version::V5>>::arbitrary(),
        orchard_shielded_data in TypeNameToDebug::<orchard::ShieldedData<tx_version::V5>>::arbitrary(),
    ) {
        let _init_guard = zebra_test::init();
    ...
    fn reject_duplicate_orchard_nullifiers_in_block(
        authorized_action1 in TypeNameToDebug::<orchard::AuthorizedAction<tx_version::V5>>::arbitrary(),
        mut authorized_action2 in TypeNameToDebug::<orchard::AuthorizedAction<tx_version::V5>>::arbitrary(),
        orchard_shielded_data1 in TypeNameToDebug::<orchard::ShieldedData<tx_version::V5>>::arbitrary(),
        orchard_shielded_data2 in TypeNameToDebug::<orchard::ShieldedData<tx_version::V5>>::arbitrary(),
    ) {
        let _init_guard = zebra_test::init();
