...
/// A custom genesis retains its full historical reserve across a legacy-width disk roundtrip.
#[test]
fn custom_genesis_nsm_seed_survives_reopen() {
