...
>>>>>>> origin/main
                    ...
                    // this seems fine from a risk or complexity perspective, but I wonder about the value add in the short term beyond deprecating pools, how expensive is it to secure the network, and whether can fees reasonable finance that?
                    // would it help to connect the block subsidy to the difficulty?
                    Err(_) => return Err(TransactionError::IncorrectFee),
                };
            }
