...
case "$1" in
    -- | cargo)
        ...
        # but we don't actually run any gRPC tests.
            ...
            ls -lh "/zebrad-cache"/*/* || (echo "No /zebrad-cache/*/*"; ls -lhR "/zebrad-cache" || echo "No /zebrad-cache directory")
            ...
            ls -lh "$ZEBRA_CACHED_STATE_DIR"/*/* || (echo "No $ZEBRA_CACHED_STATE_DIR/*/*"; ls -lhR  "$ZEBRA_CACHED_STATE_DIR" || echo "No $ZEBRA_CACHED_STATE_DIR directory")
            ...
            ls -lhR "$LIGHTWALLETD_DATA_DIR/db" || (echo "No $LIGHTWALLETD_DATA_DIR/db"; ls -lhR "$LIGHTWALLETD_DATA_DIR" || echo "No $LIGHTWALLETD_DATA_DIR directory")
