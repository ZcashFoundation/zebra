...
use zebra_chain::{
    ...
    parameters::{Network, SAPLING_VERSION_GROUP_ID},
    sapling::NotSmallOrderValueCommitment,
    transaction::{
        self, LockTime, SerializedTransaction, Transaction, UnminedTx, VerifiedUnminedTx,
    },
    transparent::Script,
};
...
pub struct TransactionObject {
    ...
    #[serde(rename = "versiongroupid", with = "opthex")]
