            ...
            joinsplits: tx
                ...
                .map(|joinsplit| {
                    ...
                    JoinSplit {
                        ...
                        anchor: rev(joinsplit.anchor.into()),
                        nullifiers: joinsplit.nullifiers.iter().map(|n| rev(n.into())).collect(),
                        commitments: joinsplit
                            .commitments
                            .iter()
                            .map(|c| rev(c.into()))
                            .collect(),
                        one_time_pubkey: rev(joinsplit.ephemeral_key.to_bytes()),
                        random_seed: rev(joinsplit.random_seed.into()),
                        macs: joinsplit.vmacs.iter().map(|m| rev(m.into())).collect(),
