...
> **Note:** This test framework is adapted from the zcashd/Bitcoin Core test framework.
> Some documentation below references "bitcoind" but applies to `zebrad` in our context.
> Example test names may differ from those in the original framework.
