...
- [Developer Documentation](dev.md)
  ...
  - [System Architecture](dev/architecture.md)
    - [The Crate Graph](dev/architecture/crate-graph.md)
    - [Services and Backpressure](dev/architecture/services.md)
    - [Startup and Orchestration](dev/architecture/startup.md)
    - [Block Lifecycle](dev/architecture/block-lifecycle.md)
    - [State](dev/architecture/state.md)
    - [Network](dev/architecture/network.md)
    - [Sync](dev/architecture/sync.md)
    - [Mempool](dev/architecture/mempool.md)
    - [RPC](dev/architecture/rpc.md)
    - [Concurrency Patterns](dev/architecture/concurrency.md)
    - [Design Decisions](dev/architecture/design-decisions.md)
