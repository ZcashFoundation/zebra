...
> **Historical Document**: This document was created for the Zebra v1.0.0-rc.0 audit in 2022.
> Dependency versions and audit scope may no longer reflect the current codebase.
> For current crate information, see the [Crates Reference](crates.md).
...
| [bincode](https://github.com/bincode-org/bincode)                                                | 1.3.3          |
...
| [abscissa_core](https://github.com/iqlusioninc/abscissa/tree/main/) | 0.5.2                                                                       |
