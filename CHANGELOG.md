...
This is the first Zebra release candidate. Zebra's consensus rules, node sync, and `lightwalletd` RPCs are ready for final testing and experimental use. Zebra has not been audited yet.
