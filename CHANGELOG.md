...
- Mempool transaction relay no longer penalizes peers for NU6.2 branch IDs
  during the first 40 heights after NU6.3 activation, avoiding bans caused
  by temporary chain-tip divergence
