...
fn zip143_deserialize_and_round_trip() {
    let tx1 = Transaction::zcash_deserialize(&test_vectors::ZIP143_1[..])
    ...
    assert_eq!(&test_vectors::ZIP143_1[..], &data1[..]);

    let tx2 = Transaction::zcash_deserialize(&test_vectors::ZIP143_2[..])
        .expect("transaction test vector from ZIP143 should deserialize");
    ...
    assert_eq!(&test_vectors::ZIP143_2[..], &data2[..]);
}

#[test]
fn zip243_deserialize_and_round_trip() {
    let tx1 = Transaction::zcash_deserialize(&test_vectors::ZIP243_1[..])
    ...
    assert_eq!(&test_vectors::ZIP243_1[..], &data1[..]);

    let tx2 = Transaction::zcash_deserialize(&test_vectors::ZIP243_2[..])
        .expect("transaction test vector from ZIP243 should deserialize");
    ...
    assert_eq!(&test_vectors::ZIP243_2[..], &data2[..]);

    let tx3 = Transaction::zcash_deserialize(&test_vectors::ZIP243_3[..])
        .expect("transaction test vector from ZIP243 should deserialize");
    ...
    assert_eq!(&test_vectors::ZIP243_3[..], &data3[..]);
}
