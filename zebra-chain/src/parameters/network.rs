...
impl Network {
    ...
    // TODO: Return `Height::MAX` instead of panicking when Canopy activation height is `None` after
    //       adding support for constructing pre-Canopy coinbase txs and block templates (#8434)
