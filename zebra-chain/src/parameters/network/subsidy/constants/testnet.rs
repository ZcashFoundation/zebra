...
pub(crate) const POST_NU6_FUNDING_STREAM_START_HEIGHT_TESTNET: u32 = 2_976_000;
...
pub(crate) const NU6_1_LOCKBOX_DISBURSEMENTS_TESTNET: [(&str, Amount<NonNegative>); 10] = [(
...
pub(crate) const POST_NU6_FUNDING_STREAM_START_RANGE_TESTNET: std::ops::Range<Height> =
...
pub(crate) const FUNDING_STREAMS_NUM_ADDRESSES_TESTNET: usize = 51;

/// List of addresses for the ECC funding stream in the Testnet.
pub(crate) const FUNDING_STREAM_ECC_ADDRESSES_TESTNET: [&str;
...
pub(crate) const FUNDING_STREAM_ZF_ADDRESSES_TESTNET: [&str;
    FUNDING_STREAMS_NUM_ADDRESSES_TESTNET] =
...
pub(crate) const FUNDING_STREAM_MG_ADDRESSES_TESTNET: [&str;
    FUNDING_STREAMS_NUM_ADDRESSES_TESTNET] =
...
///
/// [7.10]: https://zips.z.cash/protocol/protocol.pdf#fundingstreams
pub(crate) const POST_NU6_FUNDING_STREAMS_NUM_ADDRESSES_TESTNET: usize = 13;
...
///
/// [7.10]: https://zips.z.cash/protocol/protocol.pdf#fundingstreams
pub(crate) const POST_NU6_1_FUNDING_STREAMS_NUM_ADDRESSES_TESTNET: usize = 27;

/// List of addresses for the Major Grants post-NU6 funding stream on Testnet administered by the Financial Privacy Fund (FPF).
pub(crate) const POST_NU6_FUNDING_STREAM_FPF_ADDRESSES_TESTNET: [&str;
...
pub(crate) const POST_NU6_1_FUNDING_STREAM_FPF_ADDRESSES_TESTNET: [&str;
